...
const RightNavbar = () => {
  return (
    <div className="fixed right-0 top-0 970px:w-36 lg:w-1/6 h-screen bg-gray-900 text-white p-6 flex-col hidden 970px:flex max-w-64 min-w-44"> {/* Endret her */}
      ...
      <div className="flex-grow overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-300">
        <div className="grid grid-cols-1 gap-3 w-full">
          ...
          <div className="flex flex-col items-center bg-gray-800 p-3 rounded-lg w-full h-40">
            ...
            <button className="mt-3 w-24 py-1 bg-blue-600 text-sm text-white rounded-lg hover:bg-blue-500 transition duration-200 1350px:w-36 1350px:text-base">View Profile</button>
          </div>
