  ...
  const handleNavClick = (button) => {
    ...
    switch (button) {
      ...
      case 'saved':
        ...
        break;
      case 'logout':
        // Legg inn logout-logikk her om nødvendig
        break;
      default:
        break;
    }
      ...
      <div className="fixed w-full hidden 200px:w-8 510px:w-16 510px:items-center md:items-start md:w-32 870px:w-36 lg:w-52 bg-gray-900 text-white h-screen 510px:flex flex-col">
        ...
        >
          ...
          <div className="flex flex-col">
            <h2 className="text-xs hidden md:inline 870px:text-sm lg:text-lg font-semibold">BeetleJuice</h2>
            <p className="text-xs hidden md:inline 870px:text-xs lg:text-md text-gray-400">@hehey</p>
          </div>
        </a>
          ...
          <div className="flex flex-col space-y-4 mb-2">
            ...
            >
              <div className={`flex items-center space-x-3 rounded-lg py-2 870px:py-3 ${activeButton === 'saved' ? '' : 'hover:bg-gray-600'}`}>
                <span className="material-icons text-3xl md:text-lg 870px:text-2xl pl-2">bookmark</span>
