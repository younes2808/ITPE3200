  ...
  return (
    <div className="bg-orange-500 flex h-screen flex-col">
      ...
      <div className="flex w-full max-w-[1300px] mx-auto bg-blue-500">
        ...
        <div 
          ref={scrollRef} 
          className="flex-grow bg-gray-100 p-6 overflow-y-auto w-full 400px:pl-6 400px:pr-6 510px:pl-24 510px:pr-5 580px:pr-10 md:pl-44 md:pr-16 870px:pl-48 870px:pr-20 970px:pr-16 1150px:pl-64 1150px:pr-14"
        >
          <PostFunction />
          <PostFeed />
        </div>
